...
if note:
    print("  NOTE figS2 (red outline / DINOv2 row):", note)
print("  NOTE figS2: panel B rungs for the two DINOv3 encoders are literals pending the re-scrape")
T.save(fig, "figS2_representation")
