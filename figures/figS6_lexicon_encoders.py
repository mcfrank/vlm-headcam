"""S6 — human-relatedness correlations by word class, for every lexicon we have extracted.
...
print(f"  NOTE figS6: final-corpus lexicons {[LAB[f] for f in fams]}"
...
for a, l in zip(axes, "AB"):
    T.panel(a, l, dx=-0.1)
T.save(fig, "figS6_lexicon_encoders")
