"""S7 — what referential selection does to the LEXICON.
...
for enc, fam, key, col in ENC:
    ...
    if enc == "dinov3l":
        ...
        print(f"  NOTE figS7 A ({key}): aligned@100k {al.loc[100000]:.3f} vs "
...
print("  NOTE figS7 B word2vec (own text per rung): " +
...
for a, l in zip((ax, bx), "AB"):
    T.panel(a, l, dx=-0.15)
T.save(fig, "figS7_lexicon_alignment")
